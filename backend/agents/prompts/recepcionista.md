...
- `listar_horarios` — consultar vagas (modalidade opcional, data opcional AAAA-MM-DD)
- `listar_planos` — preços oficiais
- `criar_reserva` — confirmar agendamento (precisa do slot_id da listagem)
